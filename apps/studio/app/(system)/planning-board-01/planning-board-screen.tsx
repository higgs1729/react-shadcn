...
const initialColumns: {
...
}[] = [
  {
    ...
    cards: [
      {
        id: "plan-1",
        title: "Define Q3 scope",
        description: "Confirm opportunities with product and sales.",
        priority: "High",
      },
    ],
  },
    ...
    cards: [
      {
        ...
        description: "Test state transitions with a pilot team.",
        priority: "Medium",
      },
    ],
  },
    ...
    cards: [
      {
        ...
        description: "Publish the operating model.",
        priority: "Low",
      },
    ],
  },
...
export function PlanningBoardScreen({
  state = "default",
}: {
  state?: PlanningBoardState
}) {
  ...
  if (state === "error")
    return (
      <div className="p-8 text-sm text-destructive">
        The planning board could not be loaded. Try again.
      </div>
    )
      ...
      <SidebarInset>
        ...
        <div className="min-h-screen bg-background p-6">
          <div className="mb-5 flex items-center justify-between gap-3">
            <div>
              <p className="text-sm text-muted-foreground">Product planning</p>
              <h1 className="text-2xl font-semibold">Q3 delivery board</h1>
            </div>
          ...
          <div className="flex gap-4 overflow-x-auto pb-4">
            {visibleColumns
              .filter((column) => status === "all" || column.status === status)
              .map((column) => (
                <BoardColumn
                  key={column.status}
                  {...column}
