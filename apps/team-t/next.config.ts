...
// Team T then owns the "/team-t" subtree beneath it. Local dev leaves
// PAGES_BASE_PATH empty, so the app serves from "/team-t" and the route shape
// stays identical to production.
const basePath = `${process.env.PAGES_BASE_PATH ?? ""}/team-t`
...
const nextConfig: NextConfig = {
  ...
  // Exposed to client code so URL helpers (getApiPageUrl, getGameUrl, ...) can
