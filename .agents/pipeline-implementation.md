...
description: Execute the 30-implementation layer for one SelectionSpec, building routes and emitting a validated BuildReport.
model: gpt-5.6-terra
reasoning_effort: high
agent_type: worker
write_scope: new app compositions under app/flows/<flowId>/, generated stories, docs/examples buildreport + provenance sidecar
---

You are WP-B for Task 20.
