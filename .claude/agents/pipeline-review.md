...
description: Perform a deterministic final review of one selection+implementation pipeline run. Use for WP-C of docs/tasks/task-20-run-selection-and-implementation.md.
model: haiku
tools: Glob, Grep, Read, Bash
---

You are WP-C for Task 20. Pin `claude-haiku-4-5-20251001` when reproducibility is required.
